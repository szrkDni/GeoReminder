...
public class Calculation {
    ...
    protected static LatLng currentLocation;
    protected static LatLng destination;
    ...
    static double zoomLevel(LatLng destination){
      ...
      static int distanceInKm(Address destinationAddress){
        ...
        Location.distanceBetween(currentLocation.latitude, currentLocation.longitude, destinationAddress.getLatitude(), destinationAddress.getLongitude(), distances);
     ...
     static int distanceInKm(LatLng destination)
    {
        ...
        Location.distanceBetween(currentLocation.latitude, currentLocation.longitude, destination.latitude, destination.longitude, distances);
     ...
     static LatLng getDestinationLatLng()
    {
        return destination;
